...
declare global {
  ...
  const BaseBookingForm: typeof import('./src/components/match/BookingForm')['BaseBookingForm']
  const BaseChangeForm: typeof import('./src/components/match/ChangeForm')['BaseChangeForm']
  const BaseGoalForm: typeof import('./src/components/match/GoalForm')['BaseGoalForm']
  ...
  const CapModal: typeof import('./src/components/match/CapModal')['CapModal']
  const CapRating: typeof import('./src/components/match/CapRating')['CapRating']
  const CapSummary: typeof import('./src/components/match/CapSummary')['CapSummary']
  ...
  const PositionFilterPopover: typeof import('./src/components/player/PositionFilterPopover')['PositionFilterPopover']
  ...
  const competitionAtom: typeof import('./src/atoms/index')['competitionAtom']
  ...
  const matchPosTypes: typeof import('./src/constants/index')['matchPosTypes']
  ...
  const positionsByType: typeof import('./src/constants/index')['positionsByType']
  const ratingColor: typeof import('./src/utils/match')['ratingColor']
  ...
  const useCompetitionHelpers: typeof import('./src/hooks/useCompetitionHelpers')['useCompetitionHelpers']
